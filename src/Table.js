...
const Table = () => {
  ...
  const switchKeyHandler = () => {
    ...
    if (document.querySelector(".labels").style.display !== "flex") {
    ...
    <div className="periodic-table">
      ...
      <div className="multi-period">
        ...
        <div className="period-section-3">
          <div className="key">
            <table className="data-tables switchables">
              <tbody>
                <tr>
            ...
            <div className="labels switchables">
              <table>
                <tbody>
                  <tr>
        ...
        <div className="period-section-4">
          <div>
            <div
              className="filler fas fa-exchange-alt"
              onClick={switchKeyHandler}
            ></div>
